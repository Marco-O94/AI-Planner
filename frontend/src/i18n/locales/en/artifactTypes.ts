...
export const artifactTypes = {
  header: {
    ...
    description:
      "Define the artifact types that the agent should generate after analyzing the input material. An artifact type specifies how the agent generates an artifact and which files it should produce. (An artifact is an output generated by the agent, such as a plan, a report, or code.)",
    newType: "New type",
  },
  card: {
